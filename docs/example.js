!(function(e) {
      ...
      e.exports = (function() {
        ...
        U("Y", 0, 0, function() {
          ...
          he("YYYY", function(e, t) {
            t[fe] = 2 === e.length ? s.parseTwoDigitYear(e) : g(e);
          }),
          he("YY", function(e, t) {
        ...
        U("H", ["HH", 2], 0, "hour"),
          ...
          he("Hmm", function(e, t, a) {
            var n = e.length - 2;
            (t[pe] = g(e.substr(0, n))), (t[ke] = g(e.substr(n)));
          }),
          he("Hmmss", function(e, t, a) {
            var n = e.length - 4,
              s = e.length - 2;
          ...
          return (
            a &&
              ...
              ((t =
                a[ye] < 0 || a[ye] > 11
                  ? ye
                  : a[Ye] < 1 || a[Ye] > Pe(a[fe], a[ye])
                  ? Ye
                  : a[pe] < 0 ||
                    a[pe] > 24 ||
                    (24 === a[pe] &&
                      (0 !== a[ke] || 0 !== a[De] || 0 !== a[ge]))
                  ? pe
                  : a[ke] < 0 || a[ke] > 59
                  ? ke
                  : a[De] < 0 || a[De] > 59
                  ...
                  ? ge
                  : -1),
              h(e)._overflowDayOfYear && (t < fe || t > Ye) && (t = Ye),
              h(e)._overflowWeeks && -1 === t && (t = Te),
                ...
                e._w &&
                  ...
                  (function(e) {
                    ...
                    if (null != (t = e._w).GG || null != t.W || null != t.E)
                      (r = 1),
                        (i = 4),
                        (a = Mt(t.GG, e._a[fe], Ge(xt(), 1, 4).year)),
                        (n = Mt(t.W, 1)),
          ...
          if (e._f !== s.ISO_8601)
            if (e._f !== s.RFC_2822) {
              ...
              var t,
                ...
                _ = 0;
              for (
                n = V(e._f, e._locale).match(I) || [], t = 0;
                t < n.length;
                t++
              )
                (r = n[t]),
          ...
          (this._isValid = (function(e) {
            for (var t in e)
              if (-1 === Se.call(At, t) || (null != e[t] && isNaN(e[t])))
                return !1;
            for (var a = !1, n = 0; n < At.length; ++n)
              if (e[At[n]]) {
                if (a) return !1;
                parseFloat(e[At[n]]) !== g(e[At[n]]) && (a = !0);
              }
            return !0;
          })(t)),
        ...
        function Nt(e, t) {
          ...
          return t._isUTC
            ? ((a = t.clone()),
              (n =
                (k(e) || _(e) ? e.valueOf() : xt(e).valueOf()) - a.valueOf()),
          ...
          return function(a, n) {
            ...
            return (
              null === n ||
                ...
                (a = n),
                (n = s)),
              $t(this, Bt((a = "string" == typeof a ? +a : a), n), e),
              this
            );
          };
        }
        ...
        (Ya.add = Qt),
          ...
          (Ya.diff = function(e, t, a) {
            ...
            switch (
              ((s = 6e4 * (n.utcOffset() - this.utcOffset())), (t = A(t)))
            ) {
              case "year":
                r = ea(this, n) / 12;
                break;
          ...
          (Ya.from = function(e, t) {
            return this.isValid() && ((k(e) && e.isValid()) || xt(e).isValid())
              ? Bt({ to: this, from: e })
                  .locale(this.locale())
                  .humanize(!t)
          ...
          (Ya.startOf = function(e) {
            ...
            switch (e) {
              ...
              case "hour":
                (t = this._d.valueOf()),
                  (t -= oa(t + (this._isUTC ? 0 : this.utcOffset() * ra), ia));
                break;
              case "minute":
          ...
          (Ya.hour = Ya.hours = rt),
          (Ya.minute = Ya.minutes = ha),
          (Ya.second = Ya.seconds = La),
          (Ya.millisecond = Ya.milliseconds = ya),
          ...
          (Ya.dates = v("dates accessor is deprecated. Use date instead.", ca)),
          (Ya.months = v(
            "months accessor is deprecated. Use month instead",
            ze
          )),
          (Ya.years = v("years accessor is deprecated. Use year instead", He)),
          (Ya.zone = v(
        ...
        function ga(e, t, a) {
          if ((o(e) && ((t = e), (e = void 0)), (e = e || ""), null != t))
            return Da(e, t, a, "month");
          var n,
            s = [];
          for (n = 0; n < 12; n++) s[n] = Da(e, n, a, "month");
          return s;
        }
        function Ta(e, t, a, n) {
          "boolean" == typeof e
          ...
          var s,
            r = ct(),
            i = e ? r._week.dow : 0;
          if (null != a) return Da(t, (a + i) % 7, n, "day");
          var d = [];
          for (s = 0; s < 7; s++) d[s] = Da(t, (s + i) % 7, n, "day");
          return d;
        }
        (ka.calendar = function(e, t, a) {
          ...
          (ka.preparse = pa),
          (ka.postformat = pa),
          (ka.relativeTime = function(e, t, a, n) {
        ...
        function Qa() {
          ...
          if (!m) return "P0D";
          var l = m < 0 ? "-" : "",
            c = $a(this._months) !== $a(m) ? "-" : "",
            h = $a(this._days) !== $a(m) ? "-" : "",
            M = $a(this._milliseconds) !== $a(m) ? "-" : "";
          return (
            l +
            "P" +
            (r ? c + r + "Y" : "") +
  ...
  function(e, t) {
    e.exports = {
      indexOf: function(e, t) {
        ...
        for (a = 0, n = e.length; a < n; a++) if (e[a] === t) return a;
        return -1;
      },
      forEach: function(e, t, a) {
        var n, s;
        if (Array.prototype.forEach) return e.forEach(t, a);
        for (n = 0, s = e.length; n < s; n++) t.call(a, e[n], n, e);
      },
      trim: function(e) {
  ...
  function(e, t, a) {
    ...
    function g(e) {
      for (var t = "", a = 0, n = e.length; a < n; a++)
        t += e.charCodeAt(a) < 32 ? " " : e.charAt(a);
      return r.trim(t);
    }
    function T(e) {
      return (e = g((e = D((e = k((e = p(e))))))));
    }
    function w(e) {
      return (e = o((e = Y(e))));
    }
    ...
    (t.whiteList = {
      ...
      (t.onTag = function(e, t, a) {}),
      (t.onIgnoreTag = function(e, t, a) {}),
      (t.onTagAttr = function(e, t, a) {}),
      (t.onIgnoreTagAttr = function(e, t, a) {}),
      (t.safeAttrValue = function(e, t, a, n) {
        if (((a = T(a)), "href" === t || "src" === t)) {
          if ("#" === (a = r.trim(a))) return "#";
          if (
            "http://" !== a.substr(0, 7) &&
            "https://" !== a.substr(0, 8) &&
            "mailto:" !== a.substr(0, 7) &&
          ...
          if (((L.lastIndex = 0), L.test(a))) return "";
        } else if ("style" === t) {
          if (((f.lastIndex = 0), f.test(a))) return "";
          if (((y.lastIndex = 0), y.test(a) && ((L.lastIndex = 0), L.test(a))))
            return "";
          !1 !== n && (a = (n = n || d).process(a));
        }
        return (a = w(a));
      }),
      (t.escapeHtml = o),
      (t.escapeQuote = Y),
      (t.unescapeQuote = p),
      (t.escapeHtmlEntities = k),
      (t.escapeDangerHtml5Entities = D),
      (t.clearNonPrintableCharacter = g),
      ...
      (t.StripTagBody = function(e, t) {
        ...
        var a = !Array.isArray(e),
          ...
          s = !1;
        return {
          onIgnoreTag: function(i, d, o) {
            if (
              (function(t) {
                return !!a || -1 !== r.indexOf(e, t);
              })(i)
            ) {
              if (o.isClosing) {
                var _ = "[/removed]",
                  u = o.position + _.length;
                return n.push([!1 !== s ? s : o.position, u]), (s = !1), _;
              }
              return s || (s = o.position), "[removed]";
            }
            return t(i, d, o);
          },
          remove: function(e) {
  ...
  function(e, t) {
    ...
    (t.whiteList = a()),
      ...
      (t.onAttr = function(e, t, a) {}),
      (t.onIgnoreAttr = function(e, t, a) {}),
  ...
  function(e, t, a) {
    ...
    function s(e) {
      ...
      if (-1 === t) var a = e.slice(1, -1);
      else a = e.slice(1, t + 1);
      return (
        "/" === (a = n.trim(a).toLowerCase()).slice(0, 1) && (a = a.slice(1)),
    ...
    (t.parseTag = function(e, t, a) {
      ...
      for (_ = 0; _ < u; _++) {
        ...
        if (!1 === d) {
          ...
          if ("<" === c) {
            (n += a(e.slice(i, _))), (d = _), (i = _);
            continue;
          }
          if (">" === c) {
            (n += a(e.slice(i, d))),
              (m = s((l = e.slice(d, _ + 1)))),
              (n += t(d, n.length, m, l, r(l))),
              (i = _ + 1),
              (d = !1);
            continue;
          }
      ...
      return i < e.length && (n += a(e.substr(i))), n;
    }),
      (t.parseAttr = function(e, t) {
        ...
        function m(e, a) {
          if (
            !((e = (e = n.trim(e)).replace(i, "").toLowerCase()).length < 1)
          ) {
            var r = t(e, a || "");
            r && s.push(r);
          }
          ...
          if (!1 !== r || "=" !== h)
            if (
              ...
              if (/\s|\n|\t/.test(h)) {
                if (((e = e.replace(/\s|\n|\t/g, " ")), !1 === r)) {
                  if (-1 === (c = d(e, l))) {
                    m(n.trim(e.slice(a, l))), (r = !1), (a = l + 1);
                    continue;
                  }
                  l = c - 1;
                  continue;
                ...
                if (-1 === (c = o(e, l - 1))) {
                  m(r, _(n.trim(e.slice(a, l)))), (r = !1), (a = l + 1);
                  continue;
                }
              }
            } else {
              if (-1 === (c = e.indexOf(h, l + 1))) break;
              m(r, n.trim(e.slice(a + 1, c))), (r = !1), (a = (l = c) + 1);
            }
          else (r = e.slice(a, l)), (a = l + 1);
        }
        return (
          a < e.length &&
            (!1 === r ? m(e.slice(a)) : m(r, _(n.trim(e.slice(a))))),
          n.trim(s.join(" "))
        );
      });
  },
            ...
            var t =
              ...
              a =
                arguments.length > 2 && void 0 !== arguments[2]
                  ? arguments[2]
                  : void 0,
              n = { message: "", error: 0, validate: !0 };
            if ("[object File]" === Object.prototype.toString.call(e)) {
              void 0 === a && (a = 1024e3);
              var s = !0,
                r = "",
                i = e.name.lastIndexOf(".");
              -1 !== i && (r = e.name.substring(i));
              var d = r ? r.substring(1) : e.type && e.type.split("/")[0];
              e.type &&
                t &&
                ((s = t.split(",").some(function(t) {
                  return (
                    (t = t.trim()) &&
                    (new RegExp("^".concat(t)).test(e.type) ||
                      new RegExp("^".concat(t)).test(r))
                  );
                })),
                void 0 === a &&
                  (/^\.(png|jpe?g|gif|svg|webp)/.test(r) ||
                  /^image/.test(e.type)
                    ? (a = 10240)
                    : (/^\.(ogg|mp3|wav|flac|aac)/.test(r) ||
                        /^audio/.test(e.type)) &&
                      (a = 102400)));
              var o = !0;
              if (
                (a && (o = e.size / 1024 < a),
                s ||
                  ((n.message = "只能上传".concat(d, "!")),
                  (n.error = 1),
                  (n.validate = !1)),
                !o)
              ) {
                var _ =
                  a >= 1024 ? "".concat(a / 1024, "M") : "".concat(a, "KB");
                (n.message = "上传".concat(d, "大小不能超过").concat(_, "!")),
                  (n.error = 2),
                  (n.validate = !1);
              }
            } else
              (n.message = "file参数必须为File数据类型"),
                (n.error = 3),
                (n.validate = !1);
            return n;
          };
            ...
            var t =
              ...
              a =
                arguments.length > 2 && void 0 !== arguments[2]
                  ? arguments[2]
                  : "...";
            return String(e).length > t ? String(e).substring(0, t) + a : e;
          };
        }
      }));
  },
    ...
    window,
      ...
      (function(e) {
        ...
        5: function(e, t, a) {
          var n = a(6);
          function s(e) {
            n.locale("".concat(e.toLowerCase(), "-custom"));
          }
  ...
  function(e, t, a) {
    ...
    var D = (function(e) {
      function t(e) {
        ...
        return (
          ...
          (a.checkUploadHandle = a.checkUploadHandle.bind(k(k(a)))),
          (a.textOverflowHandle = a.textOverflowHandle.bind(k(k(a)))),
          (a.fileInput = s.a.createRef()),
          a
        );
      }
      var a, n, r;
      return (
        ...
        (n = [
          {
            key: "checkUploadHandle",
            value: function(e) {
              var t = this.fileInput.current.files[0];
              t
                ? this.setState({
                    checkUpload: JSON.stringify(o()(t, t.type, 1))
                  })
                : this.setState({ checkUpload: "" });
            }
          },
          {
            key: "textOverflowHandle",
            value: function(e) {
              this.setState({ textOverflow: u()(this.state.textOverflow, 3) });
            }
          },
          {
            key: "render",
            value: function() {
              return s.a.createElement(
                ...
                s.a.createElement(
                  ...
                  null,
                  "checkUpload: ",
                  this.state.checkUpload
                ),
                s.a.createElement(
                  "button",
                  { onClick: this.textOverflowHandle },
                  "超过3个字加省略符号"
                ),
                s.a.createElement(
                  "div",
    ...
    i.a.render(s.a.createElement(D, null), document.getElementById("app"));
  },
  function(e, t) {
    e.exports = function(e) {
      return (
      ...
      return s(e, function(e, t, s, o, _) {
        ...
        if (
          (!0 === u
            ...
            : "function" == typeof u
            ? (m = u(o))
            : u instanceof RegExp && (m = u.test(o)),
          !0 !== m && (m = !1),
          (o = d(s, o)))
        ) {
          var l,
            c = { position: t, sourcePosition: e, source: _, isWhite: m };
          return m
            ? r((l = n(s, o, c)))
              ? s + ":" + o
              : l
  ...
  function(e, t, a) {
    ...
    e.exports = function(e, t) {
      ...
      function o() {
        if (!s) {
          var a = n.trim(e.slice(r, i)),
            o = a.indexOf(":");
          if (-1 !== o) {
            var _ = n.trim(a.slice(0, o)),
              u = n.trim(a.slice(o + 1));
            if (_) {
              var m = t(r, d.length, _, u, a);
              m && (d += m + "; ");
            }
          }
        }
  ...
  function(e, t, a) {
    ...
    (u.prototype.process = function(e) {
      ...
      var t = this.options,
        ...
        c = t.escapeHtml,
        h = this.cssFilter;
      t.stripBlankChar && (e = s.stripBlankChar(e)),
        t.allowCommentTag || (e = s.stripCommentTag(e));
      var M = !1;
      if (t.stripIgnoreTagBody) {
        M = s.StripTagBody(t.stripIgnoreTagBody, r);
        r = M.onIgnoreTag;
      }
      var L = i(
        e,
        function(e, t, s, i, M) {
          var L,
            f = {
              ...
              position: t,
              isClosing: M,
              isWhite: a.hasOwnProperty(s)
            };
          if (!_((L = n(s, i, f)))) return L;
          if (f.isWhite) {
            if (f.isClosing) return "</" + s + ">";
            var y = (function(e) {
                var t = o.spaceIndex(e);
                if (-1 === t)
                  return { html: "", closing: "/" === e[e.length - 2] };
                var a = "/" === (e = o.trim(e.slice(t + 1, -1)))[e.length - 1];
                return (
                  a && (e = o.trim(e.slice(0, -1))), { html: e, closing: a }
                );
              })(i),
              Y = a[s],
              p = d(y.html, function(e, t) {
                var a,
                  n = -1 !== o.indexOf(Y, e);
                return _((a = u(s, e, t, n)))
                  ? n
                    ? (t = l(s, e, t, h))
                      ? e + '="' + t + '"'
                      : e
            ...
            i = "<" + s;
            return p && (i += " " + p), y.closing && (i += " /"), (i += ">");
          }
          return _((L = r(s, i, f))) ? c(i) : L;
        },
        c
      );
      return M && (L = M.remove(L)), L;
    }),
      (e.exports = u);
  }
]);
